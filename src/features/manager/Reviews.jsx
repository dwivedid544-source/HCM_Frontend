...
const Reviews = () => {
  ...
  const handleFetchAISummary = async () => {
    ...
    setAiLoading(true);
    try {
      const res = await api.aiPerformanceSummaries([], "Overall Team Feedback");
      if (res && res.data) {
        setAiData(res.data);
            ...
            <div className="p-6 sm:p-8 space-y-6 text-left bg-white dark:bg-slate-900">
               ...
               <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 text-left">
                  <div className="space-y-2 text-left">
                     ...
                     <textarea 
                        className="input-field min-h-[100px] py-3 text-sm font-bold resize-none" 
               ...
               <div className="space-y-2 text-left">
                  <div className="flex items-center justify-between">
                     ...
                     <button onClick={handleAIGenerateAssessment} className="text-[9px] font-bold text-emerald-600 dark:text-emerald-400 font-bold flex items-center gap-1 hover:text-emerald-700 dark:hover:text-emerald-300 cursor-pointer">
